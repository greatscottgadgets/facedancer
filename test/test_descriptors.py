...
class Device(USBDevice):
    ...
    product_id               : int         = 0x0005
    manufacturer_string      : str         = 'Facedancer Test'
    product_string           : str         = 'Gamepad With Audio'
    ...
    class Configuration_1(USBConfiguration):
        ...
        class Interface_1_1(USBInterface):
            ...
            class Endpoint_1_OUT(USBEndpoint):
                ...
                synchronization_type : USBSynchronizationType = USBSynchronizationType.ADAPTIVE
                usage_type           : USBUsageType           = USBUsageType.DATA
                max_packet_size      : int                    = 392
                interval             : int                    = 4
                extra_bytes          : bytes                  = bytes([0x00, 0x00])

                class Descriptor_0x25_A(USBDescriptor):
                    type_number       : int  = 0x25
                    include_in_config : bool = True
                    number            : int  = None

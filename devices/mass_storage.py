...
class USBMassStorageInterface(USBInterface):
    ...
    def _initialize_scsi_commands(self):
        ...
        self._register_scsi_command(ScsiCmds.TEST_UNIT_READY, "Test Unit Ready", self.handle_test_unit_ready)
        ...
        self._register_scsi_command(ScsiCmds.MODE_SENSE_6, "Mode Sense (6)", self.handle_mode_sense_6)
        self._register_scsi_command(ScsiCmds.MODE_SENSE_10, "Mode Sense (10)", self.handle_mode_sense_10)
        self._register_scsi_command(ScsiCmds.PREVENT_ALLOW_MEDIUM_REMOVAL, "Prevent/Allow Removal", self.handle_prevent_allow_medium_removal)
        self._register_scsi_command(ScsiCmds.READ_FORMAT_CAPACITIES, "Get Format Capacity", self.handle_read_format_capacities)
        ...
        self._register_scsi_command(ScsiCmds.SYNCHRONIZE_CACHE2, "Synchronize Cache2", self.handle_synchronize_cache)
        ...
        self._register_scsi_command(ScsiCmds.SYNCHRONIZE_CACHE, "Synchronize Cache", self.handle_synchronize_cache)
        self._register_scsi_command(ScsiCmds.READ_CAPACITY_16, "Read Capacity 16", self.handle_read_capacity_16)
    ...
    def handle_mode_sense_6(self, cbw):
        ...
        page &= 0x3f
        return self.STATUS_OKAY, self.handle_scsi_mode_sense(6, page, subpage, alloc_len, control)
    ...
    def handle_mode_sense_10(self, cbw):
        ...
        page &= 0x3f
        return self.STATUS_OKAY, self.handle_scsi_mode_sense(10, page, subpage, alloc_len, control)
    '''

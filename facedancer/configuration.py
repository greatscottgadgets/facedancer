...
class {name}(USBConfiguration):
    ...
    configuration_string   : str  = {repr(self.configuration_string)}
    max_power              : int  = {self.max_power}
    self_powered           : bool = {repr(self.self_powered)}
    supports_remote_wakeup : bool = {repr(self.supports_remote_wakeup)}
"""
